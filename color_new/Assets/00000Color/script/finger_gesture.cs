...
//						STATE._STATE = "WAIT";
		...
		void OnFingerDown (FingerDownEvent e)
		{
				...
				if (e.Selection.tag.Equals ("ball")) {
//						Destroy (e.Selection);
//						e.Selection.GetComponent<ComboBallController> ().isInCombo = true;
//						GetComponent<GameController> ().StartCombo (e.Selection);
			GameObject.Find("BallMatrix").SendMessage("oneCombo");
				}
				switch (e.Selection.name) {
