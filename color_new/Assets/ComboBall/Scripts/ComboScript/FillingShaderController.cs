...
public class FillingShaderController : MonoBehaviour {
	...
	public void Init(float currentVal, float maxVal)
	{
		...
		inited = true;
		renderer.material.SetColor("_Color", Color.Lerp(emptyColor, fullColor, currentValue / maxValue));
	}
	...
	void Update () 
	{
		if(targetValue != currentValue)
		{
			...
			renderer.material.SetFloat("_FillUpTo", Mathf.Min(1.0f, currentValue / maxValue));
			renderer.material.SetColor("_Color", Color.Lerp(emptyColor, fullColor, currentValue / maxValue));
		}
	}
