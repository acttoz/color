...
public class AudioCalcEventInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (aud == null || aud.clip == null) {
            ...
            EditorGUILayout.LabelField("Audio Source Ended Sound - needs AudioSource component and an Audio Clip assigned.", EditorStyles.whiteMiniLabel);
            ...
            if (sounds.useAudioSourceEndedSound && !sounds.disableSounds) {
				...
				var newVolume = DTGUIHelper.DisplayVolumeField(sounds.audioSourceEndedSound.volume, DTGUIHelper.VolumeFieldType.None, 0f, true);
