...
{
		public GameObject touchPoint, balloon;
...
//		{
//				 	
//				balloon = Instantiate (prf_balloon, touch, Quaternion.identity) as GameObject;
//				GameObject.Find ("Main Camera").transform.parent = balloon.transform;
