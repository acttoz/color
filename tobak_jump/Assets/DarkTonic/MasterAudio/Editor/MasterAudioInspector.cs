    ...
    public override void OnInspectorGUI() {
        ...
        if (sounds.showAdvancedSettings) {
            ...
            if (sounds.visualAdvancedExpanded) {
                EditorGUI.indentLevel = 1;
                var newFast = EditorGUILayout.Toggle(new GUIContent("Fast GUI Refresh", "This option is extremely CPU intensive, use only if you really need to."), sounds.enableFastResponse);
