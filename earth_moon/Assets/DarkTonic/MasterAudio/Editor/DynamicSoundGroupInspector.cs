...
public class DynamicSoundGroupInspector : Editor {
	...
	private DynamicSoundGroupCreator _creator = null;
	...
	public override void OnInspectorGUI() {
		...
		var newVol = DTGUIHelper.DisplayVolumeField(_group.groupMasterVolume, DTGUIHelper.VolumeFieldType.None, 0f, true, "Group Master Volume");
		...
		if (_group.groupVariations.Count == 0) {
			...
			for (var i = 0; i < _group.groupVariations.Count; i++) {
				...
				var newVolume = DTGUIHelper.DisplayVolumeField(variation.VarAudio.volume, DTGUIHelper.VolumeFieldType.None, 0f, true);
				...
				if (variation.useRandomVolume) {
					...
					var newVolMin = DTGUIHelper.DisplayVolumeField(variation.randomVolumeMin, DTGUIHelper.VolumeFieldType.None, volMin, true, "Random Volume Min");
					...
					var newVolMax = DTGUIHelper.DisplayVolumeField(variation.randomVolumeMax, DTGUIHelper.VolumeFieldType.None, volMin, true, "Random Volume Max");
